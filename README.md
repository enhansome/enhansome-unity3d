...
* [Spine Runtimes](https://github.com/EsotericSoftware/spine-runtimes) ⭐ 5,297 | 🐛 82 | 🌐 C++ | 📅 2026-09-17 - Collection of Spine runtimes including with Unity3d version.
...
* [Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,299 | 🐛 52 | 🌐 C# | 📅 2026-09-17 - Open-source MCP server connecting AI agents (Claude, Cursor, GitHub Copilot, Gemini, and more) to the Unity Editor and runtime, with 100+ built-in tools.
...
* [StableDiffusionUnityTools](https://github.com/KonH/StableDiffusionUnityTools) ⭐ 64 | 🐛 0 | 🌐 C# | 📅 2023-01-14 - Editor assets generation via Stable Diffusion
* [XdUnityUI](https://github.com/itouh2-i0plus/XdUnityUI) - AdobeXd to UnityUI converter

### Asset Bundle / Addressable Assets

* [YooAsset](https://github.com/tuyoogame/YooAsset) ⭐ 3,366 | 🐛 201 | 🌐 C# | 📅 2026-09-20 - unity3d resources management system
...
* [Latios-Framework](https://github.com/Dreaming381/Latios-Framework) ⭐ 1,352 | 🐛 3 | 🌐 C# | 📅 2026-09-07 - A Unity DOTS framework
...
* [Unity-Editor-Toolbox](https://github.com/arimger/Unity-Editor-Toolbox) ⭐ 1,976 | 🐛 12 | 🌐 C# | 📅 2026-08-25 - Tools, custom attributes, drawers and extensions for Unity Editor.
...
* [Texture Panner](https://github.com/AdultLink/TexturePanner) ⭐ 745 | 🐛 2 | 🌐 C# | 📅 2022-03-09 - Awesome shader collection
* [TexturePanner](https://github.com/AdultLink/TexturePanner) ⭐ 745 | 🐛 2 | 🌐 C# | 📅 2022-03-09 - This repository hosts a shader for Unity3D whose main goal is to facilitate the creation of neon-like signs, conveyor belts and basically whatever based on scrolling textures
...
* [JourneySand](https://github.com/AtwoodDeng/JourneySand) ⭐ 446 | 🐛 0 | 🌐 C# | 📅 2018-02-22 - An Unity project to reproduce the sand rendering in Journey's style
...
* [foliage-wind](https://github.com/happy-turtle/foliage-wind) ⭐ 30 | 🐛 0 | 🌐 HLSL | 📅 2021-10-18 - Foliage wind shader implementations for Unity's render pipelines HDRP and URP. Based on the demo project Book of the Dead by Unity.
...
* [crest-oceanrender](https://github.com/huwb/crest-oceanrender) ⭐ 3,900 | 🐛 83 | 🌐 C# | 📅 2026-06-18 - An advanced ocean system implemented in Unity3D
...
* [QFramework](https://github.com/liangxiegame/QFramework) ⭐ 5,455 | 🐛 8 | 🌐 C# | 📅 2026-09-20 - Your first K.I.S.S Unity 3D Framework
...
* [UnityNeuroSpeech](https://github.com/HardCodeDev777/UnityNeuroSpeech) ⭐ 51 | 🐛 0 | 🌐 C# | 📅 2026-01-21 -  World’s first Unity framework that lets you talk to AI in real time — locally.
...
* [NavMeshPlus](https://github.com/h8man/NavMeshPlus) ⭐ 2,349 | 🐛 23 | 🌐 C# | 📅 2026-08-29 - Unity NavMesh 2D Pathfinding
...
* [UnityHFSM](https://github.com/Inspiaaa/UnityHFSM) ⭐ 1,609 | 🐛 11 | 🌐 C# | 📅 2026-03-25 - A fast, tried-and-tested hierarchical finite state machine library for Unity, designed to be easy to use yet powerful without compromising performance.
...
* [LDtkUnity](https://github.com/Cammin/LDtkUnity) ⭐ 425 | 🐛 14 | 🌐 C# | 📅 2026-04-11 - A package for easy Unity-integration with the Level Designer Toolkit, created by deepnight: <https://github.com/deepnight/ldtk> ⭐ 4,192 | 🐛 387 | 🌐 Haxe | 📅 2026-07-12
...
* [MediaPipeUnityPlugin](https://github.com/homuler/MediaPipeUnityPlugin) ⭐ 2,469 | 🐛 53 | 🌐 C# | 📅 2026-01-10 - Unity plugin to run MediaPipe
...
* [ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,099 | 🐛 174 | 🌐 C# | 📅 2026-09-20 - .NET Decompiler with support for PDB generation, ReadyToRun, Metadata (\&more) - cross-platform!
...
* [Harmony](https://github.com/pardeike/Harmony) ⭐ 6,657 | 🐛 17 | 🌐 C# | 📅 2026-09-08 - A library for patching, replacing and decorating .NET and Mono methods during runtime.
* [Fody](https://github.com/Fody/Fody) ⭐ 4,543 | 🐛 8 | 🌐 C# | 📅 2026-09-16 - Extensible tool for weaving .net assemblies.
* [MelonLoader](https://github.com/LavaGang/MelonLoader) ⭐ 4,199 | 🐛 46 | 🌐 C# | 📅 2026-09-05 - The World's First Universal Mod Loader for Unity Games that is Compatible with both Il2Cpp and Mono.
...
* [UnityDoorstop](https://github.com/NeighTools/UnityDoorstop) ⭐ 594 | 🐛 26 | 🌐 C | 📅 2026-09-01 - Doorstop -- run C# before Unity does!
...
* [FishNet](https://github.com/FirstGearGames/FishNet) ⭐ 2,053 | 🐛 14 | 🌐 C# | 📅 2026-09-02 - FishNet: Unity Networking Evolved
...
* [UnityWebSocket](https://github.com/psygames/UnityWebSocket) ⭐ 1,208 | 🐛 9 | 🌐 C# | 📅 2025-09-16 - The Best Unity WebSocket Plugin for All Platforms.
...
* [PurrNet](https://github.com/PurrNet/PurrNet) ⭐ 676 | 🐛 4 | 🌐 C# | 📅 2026-09-19 - A Purrfect Unity Networking Solution
...
* [OpenUPM](https://github.com/openupm/openupm) ⭐ 1,911 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-20 - OpenUPM - Open Source Unity Package Registry (UPM)
...
* [ProceduralToolkit](https://github.com/Syomus/ProceduralToolkit) ⭐ 2,905 | 🐛 14 | 🌐 C# | 📅 2024-04-04 - Procedural generation library for Unity
...
* [puerts](https://github.com/Tencent/puerts) ⭐ 6,207 | 🐛 311 | 🌐 C++ | 📅 2026-09-20 - PUER(普洱) Typescript. Let's write your game in UE or Unity with TypeScript.
* [YarnSpinner](https://github.com/YarnSpinnerTool/YarnSpinner) ⭐ 2,842 | 🐛 3 | 🌐 C# | 📅 2026-09-16 - Yarn Spinner is a tool for building interactive dialogue in games!
...
* [PrimeTween](https://github.com/KyryloKuzyk/PrimeTween) ⭐ 1,990 | 🐛 6 | 🌐 C# | 📅 2026-07-18 - High-performance, allocation-free tween library for Unity. Create animations, delays, and sequences in one line of code.
...
* [UIEffect](https://github.com/mob-sakai/UIEffect) ⭐ 7,659 | 🐛 9 | 🌐 C# | 📅 2026-08-27 - UIEffect is an effect component for uGUI element in Unity. Let's decorate your UI with effects!
...
* [ReactUnity](https://github.com/ReactUnity/core) ⭐ 899 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-15 - React and HTML framework for Unity UI & UIToolkit
...
* [ZLinq](https://github.com/Cysharp/ZLinq) ⭐ 5,272 | 🐛 6 | 🌐 C# | 📅 2026-07-08 - Zero allocation LINQ with LINQ to Span, LINQ to SIMD, and LINQ to Tree (FileSystem, JSON, GameObject, etc.) for all .NET platforms and Unity, Godot.
...
* [R3](https://github.com/Cysharp/R3) ⭐ 3,996 | 🐛 27 | 🌐 C# | 📅 2026-08-26 - The new future of dotnet/reactive and UniRx.
...
* [unity-webview](https://github.com/gree/unity-webview) ⭐ 2,664 | 🐛 443 | 🌐 Objective-C++ | 📅 2026-08-28 - A plugin for Unity 5 that overlays WebView components on Unity view. It works on Android, iOS, Unity Web Player, and OS X (Windows is not supported for now).
