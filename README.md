...
* [Spine Runtimes](https://github.com/EsotericSoftware/spine-runtimes) ⭐ 5,271 | 🐛 83 | 🌐 C++ | 📅 2026-08-28 - Collection of Spine runtimes including with Unity3d version.
...
* [Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,017 | 🐛 52 | 🌐 C# | 📅 2026-08-24 - Open-source MCP server connecting AI agents (Claude, Cursor, GitHub Copilot, Gemini, and more) to the Unity Editor and runtime, with 100+ built-in tools.
...
* [Materialize](https://github.com/BoundingBoxSoftware/Materialize) ⭐ 1,793 | 🐛 47 | 🌐 C# | 📅 2024-06-24 - Materialize is a program for converting images to materials for use in video games and whatnot
...
* [YooAsset](https://github.com/tuyoogame/YooAsset) ⭐ 3,351 | 🐛 207 | 🌐 C# | 📅 2026-08-11 - unity3d resources management system
...
* [VContainer](https://github.com/hadashiA/VContainer) ⭐ 3,044 | 🐛 102 | 🌐 C# | 📅 2026-07-01 - The extra fast, minimum code size, GC-free DI (Dependency Inject) library running on Unity (IL2CPP).
...
* [KinoGlitch](https://github.com/keijiro/KinoGlitch) ⭐ 2,812 | 🐛 7 | 🌐 C# | 📅 2023-12-05 - Video glitch effects for Unity
...
* [QFramework](https://github.com/liangxiegame/QFramework) ⭐ 5,428 | 🐛 9 | 🌐 C# | 📅 2026-08-23 - Your first K.I.S.S Unity 3D Framework
...
* [NavMeshPlus](https://github.com/h8man/NavMeshPlus) ⭐ 2,337 | 🐛 23 | 🌐 C# | 📅 2026-08-29 - Unity NavMesh 2D Pathfinding
...
* [LDtkUnity](https://github.com/Cammin/LDtkUnity) ⭐ 426 | 🐛 14 | 🌐 C# | 📅 2026-04-11 - A package for easy Unity-integration with the Level Designer Toolkit, created by deepnight: <https://github.com/deepnight/ldtk> ⭐ 4,168 | 🐛 379 | 🌐 Haxe | 📅 2026-07-12
...
* [xLua](https://github.com/Tencent/xLua) ⭐ 10,179 | 🐛 288 | 🌐 C | 📅 2025-11-21 - xLua is a hot-fix solution plugin for Unity3D, it supports android, ios, windows, osx, etc.
* [MoonSharp](https://github.com/xanathar/moonsharp/) ⭐ 1,614 | 🐛 112 | 🌐 C# | 📅 2026-08-04 - An interpreter for the Lua language, written entirely in C# for the .NET, Mono, Xamarin and Unity3D platforms, including handy remote debugger facilities
...
* [UnityGLTF](https://github.com/KhronosGroup/UnityGLTF) ⭐ 2,225 | 🐛 79 | 🌐 C# | 📅 2026-08-21 - Runtime GLTF Loader for Unity3D
...
* [ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,974 | 🐛 185 | 🌐 C# | 📅 2026-08-30 - .NET Decompiler with support for PDB generation, ReadyToRun, Metadata (\&more) - cross-platform!
...
* [Facepunch.Steamworks](https://github.com/Facepunch/Facepunch.Steamworks) ⭐ 3,735 | 🐛 212 | 🌐 C# | 📅 2026-08-20 - Another fucking c# Steamworks implementation
...
* [FishNet](https://github.com/FirstGearGames/FishNet) ⭐ 2,032 | 🐛 18 | 🌐 C# | 📅 2026-08-21 - FishNet: Unity Networking Evolved
...
* [PurrNet](https://github.com/PurrNet/PurrNet) ⭐ 645 | 🐛 3 | 🌐 C# | 📅 2026-08-29 - A Purrfect Unity Networking Solution
...
* [NuGetForUnity](https://github.com/GlitchEnzo/NuGetForUnity) ⭐ 4,561 | 🐛 88 | 🌐 C# | 📅 2026-04-19 - A NuGet Package Manager for Unity
* [OpenUPM](https://github.com/openupm/openupm) ⭐ 1,896 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-30 - OpenUPM - Open Source Unity Package Registry (UPM)
...
* [RuntimeUnityEditor](https://github.com/ManlyMarco/RuntimeUnityEditor) ⭐ 1,110 | 🐛 9 | 🌐 C# | 📅 2026-08-04 - In-game inspector and debugging tools for applications made with Unity3D game engine
...
* [leanclr](https://github.com/focus-creative-games/leanclr) ⭐ 664 | 🐛 0 | 🌐 C++ | 📅 2026-07-23 - LeanCLR is a lean, cross-platform implementation of the Common Language Runtime (CLR).
...
* [UnityScreenNavigator](https://github.com/Haruma-K/UnityScreenNavigator) ⭐ 1,116 | 🐛 0 | 🌐 C# | 📅 2026-08-18 - Library for screen transitions, transition animations, transition history stacking, and screen lifecycle management in Unity's uGUI.
...
* [eos\_plugin\_for\_unity](https://github.com/PlayEveryWare/eos_plugin_for_unity) ⭐ 416 | 🐛 11 | 🌐 C# | 📅 2026-08-28 - The eos\_plugin\_for\_unity repository contains the source code for development and support of the Epic Online Services Plugin for Unity (UPM Package) package.
...
* [LitMotion](https://github.com/AnnulusGames/LitMotion) ⭐ 2,292 | 🐛 48 | 🌐 C# | 📅 2026-06-30 - Lightning-fast and Zero Allocation Tween Library for Unity.
...
* [UIEffect](https://github.com/mob-sakai/UIEffect) ⭐ 7,613 | 🐛 9 | 🌐 C# | 📅 2026-08-27 - UIEffect is an effect component for uGUI element in Unity. Let's decorate your UI with effects!
* [ParticleEffectForUGUI](https://github.com/mob-sakai/ParticleEffectForUGUI) ⭐ 5,974 | 🐛 42 | 🌐 C# | 📅 2026-08-27 - This plugin provide a component to render particle effect for uGUI in Unity 2018.2+. The particle rendering is maskable and sortable, without Camera, RenderTexture or Canvas
...
* [ZLinq](https://github.com/Cysharp/ZLinq) ⭐ 5,248 | 🐛 5 | 🌐 C# | 📅 2026-07-08 - Zero allocation LINQ with LINQ to Span, LINQ to SIMD, and LINQ to Tree (FileSystem, JSON, GameObject, etc.) for all .NET platforms and Unity, Godot.
...
* [R3](https://github.com/Cysharp/R3) ⭐ 3,974 | 🐛 28 | 🌐 C# | 📅 2026-08-26 - The new future of dotnet/reactive and UniRx.
...
* [Evolunity](https://github.com/Bodix/Evolunity) ⭐ 64 | 🐛 1 | 🌐 C# | 📅 2026-08-30 - Well-designed package with useful scripting tools for Unity development
