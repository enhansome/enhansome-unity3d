...
* [DragonBonesCSharp](https://github.com/DragonBones/DragonBonesCSharp) ⭐ 578 | 🐛 52 | 🌐 C# | 📅 2026-05-08 - DragonBones C# Runtime
...
* [Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 3,960 | 🐛 50 | 🌐 C# | 📅 2026-08-19 - Open-source MCP server connecting AI agents (Claude, Cursor, GitHub Copilot, Gemini, and more) to the Unity Editor and runtime, with 100+ built-in tools.
...
* [unity-builder](https://github.com/game-ci/unity-builder) ⭐ 1,083 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-22 - Github action for testing and building Unity projects (formerly webbertakken/unity-actions)
...
* [CSharp Console](https://github.com/niqibiao/unity-csharpconsole) ⭐ 15 | 🐛 0 | 🌐 C# | 📅 2026-08-22 - Interactive Roslyn-powered C# REPL for Unity Editor and Runtime. Persistent session state, private member access, remote Player execution via HybridCLR, and an extensible command framework. No compilation wait.

### DOTS

* [Latios-Framework](https://github.com/Dreaming381/Latios-Framework) ⭐ 1,344 | 🐛 0 | 🌐 C# | 📅 2026-08-15 - A Unity DOTS framework
...
* [Zenject](https://github.com/modesttree/Zenject) ⭐ 2,934 | 🐛 156 | 🌐 C# | 📅 2024-01-26 - Dependency Injection Framework for Unity3D
...
* [UnityGoogleDrive](https://github.com/Elringus/UnityGoogleDrive) ⭐ 423 | 🐛 11 | 🌐 C# | 📅 2025-10-15 - Google Drive SDK for Unity game engine
...
* [NaughtyAttributes](https://github.com/dbrizov/NaughtyAttributes) ⭐ 5,200 | 🐛 127 | 🌐 C# | 📅 2026-06-29 - Attribute Extensions for Unity

* [FastScriptReload](https://github.com/handzlikchris/FastScriptReload) ⭐ 2,233 | 🐛 100 | 🌐 C# | 📅 2026-04-01 - Hot Reload implementation for Unity. Iterate on code insanely fast without breaking play session. Supports any editor. 1. Play 2. Make change 3. See results
...
* [X-PostProcessing-Library](https://github.com/QianMo/X-PostProcessing-Library) ⭐ 3,554 | 🐛 5 | 🌐 C# | 📅 2023-07-14 - XPL : High Quality Post Processing Effects Library For Unity
...
* [SSMS](https://github.com/OCASM/SSMS) ⭐ 749 | 🐛 4 | 🌐 C# | 📅 2025-07-30 - Screen space multiple scattering for Unity
...
* [QFramework](https://github.com/liangxiegame/QFramework) ⭐ 5,419 | 🐛 9 | 🌐 C# | 📅 2026-07-11 - Your first K.I.S.S Unity 3D Framework
...
* [SanAndreasUnity](https://github.com/GTA-ASM/SanAndreasUnity) ⭐ 2,607 | 🐛 40 | 🌐 C# | 📅 2023-06-16 - Open source reimplementation of GTA San Andreas game engine in Unity
* [ezy-slice](https://github.com/DavidArayan/ezy-slice) ⭐ 2,264 | 🐛 10 | 🌐 C# | 📅 2023-08-10 - An open source mesh slicer framework for Unity3D Game Engine. Written in C#.
...
* [realtime-CSG-for-unity](https://github.com/LogicalError/realtime-CSG-for-unity) ⭐ 1,005 | 🐛 69 | 🌐 C# | 📅 2026-03-28 - Realtime-CSG, CSG level editor for Unity
...
* [LDtkUnity](https://github.com/Cammin/LDtkUnity) ⭐ 426 | 🐛 14 | 🌐 C# | 📅 2026-04-11 - A package for easy Unity-integration with the Level Designer Toolkit, created by deepnight: <https://github.com/deepnight/ldtk> ⭐ 4,161 | 🐛 377 | 🌐 Haxe | 📅 2026-07-12
...
* [xLua](https://github.com/Tencent/xLua) ⭐ 10,169 | 🐛 288 | 🌐 C | 📅 2025-11-21 - xLua is a hot-fix solution plugin for Unity3D, it supports android, ios, windows, osx, etc.
...
* [Deform](https://github.com/keenanwoodall/Deform) ⭐ 3,675 | 🐛 20 | 🌐 C# | 📅 2024-10-04 - A fully-featured deformer system for Unity
...
* [ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 25,917 | 🐛 190 | 🌐 C# | 📅 2026-08-22 - .NET Decompiler with support for PDB generation, ReadyToRun, Metadata (\&more) - cross-platform!
...
* [MelonLoader](https://github.com/LavaGang/MelonLoader) ⭐ 4,125 | 🐛 43 | 🌐 C# | 📅 2026-08-13 - The World's First Universal Mod Loader for Unity Games that is Compatible with both Il2Cpp and Mono.
...
* [Google Mobile Ads Unity Plugin](https://github.com/googleads/googleads-mobile-unity) ⭐ 1,541 | 🐛 166 | 🌐 C# | 📅 2026-08-22 - Official Unity Plugin for the Google Mobile Ads SDK
...
* [FishNet](https://github.com/FirstGearGames/FishNet) ⭐ 2,026 | 🐛 17 | 🌐 C# | 📅 2026-08-21 - FishNet: Unity Networking Evolved
...
* [PurrNet](https://github.com/PurrNet/PurrNet) ⭐ 639 | 🐛 4 | 🌐 C# | 📅 2026-08-21 - A Purrfect Unity Networking Solution
...
* [graphQL-client-unity](https://github.com/Gazuntype/graphQL-client-unity) ⭐ 292 | 🐛 36 | 🌐 C# | 📅 2022-07-27 - This repository houses a unitypackage that can be included in your Unity Project to enable it communicate with a graphQL server.
...
* [NuGetForUnity](https://github.com/GlitchEnzo/NuGetForUnity) ⭐ 4,551 | 🐛 87 | 🌐 C# | 📅 2026-04-19 - A NuGet Package Manager for Unity
...
* [UnityJigglePhysics](https://github.com/naelstrof/UnityJigglePhysics) ⭐ 567 | 🐛 14 | 🌐 ShaderLab | 📅 2026-05-05 - A unity addon for adding stretchy bouncy physics to bones and meshes.
...
* [wavefunctioncollapse](https://github.com/marian42/wavefunctioncollapse/) ⭐ 4,855 | 🐛 9 | 🌐 C# | 📅 2021-03-28 - Walk through an infinite, procedurally generated city
...
* [protobuf-net](https://github.com/mgravell/protobuf-net) ⭐ 4,969 | 🐛 537 | 🌐 C# | 📅 2026-08-22 - Protocol Buffers library for idiomatic .NET
...
* [hybridclr](https://github.com/focus-creative-games/hybridclr) ⭐ 7,952 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 - HybridCLR is a fully featured, zero-cost, high-performance, low-memory solution for Unity's all-platform native c# hotupdate.
...
* [odin-serializer](https://github.com/TeamSirenix/odin-serializer) ⭐ 1,896 | 🐛 27 | 🌐 C# | 📅 2026-07-21 - Fast, robust, powerful and extendible .NET serializer built for Unity
...
* [LitMotion](https://github.com/AnnulusGames/LitMotion) ⭐ 2,285 | 🐛 48 | 🌐 C# | 📅 2026-06-30 - Lightning-fast and Zero Allocation Tween Library for Unity.
* [PrimeTween](https://github.com/KyryloKuzyk/PrimeTween) ⭐ 1,971 | 🐛 6 | 🌐 C# | 📅 2026-07-18 - High-performance, allocation-free tween library for Unity. Create animations, delays, and sequences in one line of code.
...
* [Randomation-Vehicle-Physics](https://github.com/JustInvoke/Randomation-Vehicle-Physics) ⭐ 933 | 🐛 24 | 🌐 C# | 📅 2022-11-13 - Vehicle physics system for the Unity engine.
...
* [UIEffect](https://github.com/mob-sakai/UIEffect) ⭐ 7,594 | 🐛 9 | 🌐 C# | 📅 2026-08-17 - UIEffect is an effect component for uGUI element in Unity. Let's decorate your UI with effects!
* [ParticleEffectForUGUI](https://github.com/mob-sakai/ParticleEffectForUGUI) ⭐ 5,957 | 🐛 43 | 🌐 C# | 📅 2026-07-04 - This plugin provide a component to render particle effect for uGUI in Unity 2018.2+. The particle rendering is maskable and sortable, without Camera, RenderTexture or Canvas
...
* [FairyGUI-unity](https://github.com/fairygui/FairyGUI-unity) ⭐ 2,964 | 🐛 26 | 🌐 C# | 📅 2026-02-03 - A flexible UI framework for Unity
* [LoopScrollRect](https://github.com/qiankanglai/LoopScrollRect) ⭐ 2,767 | 🐛 1 | 🌐 C# | 📅 2026-06-07 - UGUI ScrollRect reusing cells, to improve performance, loading time and draw calls.
...
* [graphy](https://github.com/Tayx94/graphy) ⭐ 2,897 | 🐛 12 | 🌐 C# | 📅 2024-06-04 - Graphy is the ultimate, easy to use, feature packed stats monitor and debugger for your Unity project
* [Mathfs](https://github.com/FreyaHolmer/Mathfs) ⭐ 2,748 | 🐛 3 | 🌐 C# | 📅 2026-07-31 - Expanded Math Functionality for Unity
* [UnityStandaloneFileBrowser](https://github.com/gkngkc/UnityStandaloneFileBrowser) ⭐ 2,458 | 🐛 101 | 🌐 C# | 📅 2024-04-29 - A native file browser for unity standalone platforms
...
* [Evolunity](https://github.com/Bodix/Evolunity) ⭐ 64 | 🐛 1 | 🌐 C# | 📅 2026-08-22 - Well-designed package with useful scripting tools for Unity development
...
* [Simple-WebXR-Unity](https://github.com/Rufus31415/Simple-WebXR-Unity) ⭐ 609 | 🐛 13 | 🌐 C# | 📅 2025-11-12 - SimpleWebXR is a lightweight library that exposes the WebXR javascript API in your C# Unity code.
...
* [unity-webview](https://github.com/gree/unity-webview) ⭐ 2,656 | 🐛 441 | 🌐 Objective-C++ | 📅 2026-08-20 - A plugin for Unity 5 that overlays WebView components on Unity view. It works on Android, iOS, Unity Web Player, and OS X (Windows is not supported for now).
