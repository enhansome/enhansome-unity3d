...
* [SpriteDicing](https://github.com/Elringus/SpriteDicing) ⭐ 1,513 | 🐛 1 | 🌐 Rust | 📅 2026-04-14 - Extension for Unity game engine to work with diced sprites
* [Unity2D-Components](https://github.com/cmilr/Unity2D-Components) ⭐ 816 | 🐛 1 | 🌐 C# | 📅 2021-01-23 - A constantly evolving array of Unity C# components for 2D games, including classes for pixel art cameras, events & messaging, saving & loading game data, collision handlers, object pools, and more.
...
* [Spine Runtimes](https://github.com/EsotericSoftware/spine-runtimes) ⭐ 5,254 | 🐛 81 | 🌐 C++ | 📅 2026-08-20 - Collection of Spine runtimes including with Unity3d version.
...
* [Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 3,956 | 🐛 50 | 🌐 C# | 📅 2026-08-19 - Open-source MCP server connecting AI agents (Claude, Cursor, GitHub Copilot, Gemini, and more) to the Unity Editor and runtime, with 100+ built-in tools.
...
* [obfuz](https://github.com/focus-creative-games/obfuz) ⭐ 795 | 🐛 0 | 🌐 C# | 📅 2026-07-19 - A powerful open-source code obfuscation plugin for Unity
...
* [unity-builder](https://github.com/game-ci/unity-builder) ⭐ 1,083 | 🐛 100 | 🌐 TypeScript | 📅 2026-08-18 - Github action for testing and building Unity projects (formerly webbertakken/unity-actions)
...
* [VContainer](https://github.com/hadashiA/VContainer) ⭐ 3,037 | 🐛 101 | 🌐 C# | 📅 2026-07-01 - The extra fast, minimum code size, GC-free DI (Dependency Inject) library running on Unity (IL2CPP).
* [Zenject](https://github.com/modesttree/Zenject) ⭐ 2,933 | 🐛 156 | 🌐 C# | 📅 2024-01-26 - Dependency Injection Framework for Unity3D
* [reflex](https://github.com/gustavopsantos/reflex) ⭐ 1,610 | 🐛 10 | 🌐 C# | 📅 2026-06-18 - Minimal dependency injection framework for Unity
...
* [NaughtyAttributes](https://github.com/dbrizov/NaughtyAttributes) ⭐ 5,201 | 🐛 127 | 🌐 C# | 📅 2026-06-29 - Attribute Extensions for Unity
...
* [Unity-Reorderable-List](https://github.com/cfoulston/Unity-Reorderable-List) ⭐ 646 | 🐛 7 | 🌐 C# | 📅 2021-01-06 - Extended version of the Reorderable List in Unity
...
* [SuperEditor](https://github.com/UnitySuperEditor/SuperEditor) ⭐ 260 | 🐛 24 | 📅 2022-05-17 - Super Editor is a versatile Unity editor extension that includes a powerful, easy-to-use built-in IDE, Hieararchy enhancements, and Favorites enhancements
...
* [NovaShader](https://github.com/CyberAgentGameEntertainment/NovaShader) ⭐ 1,606 | 🐛 0 | 🌐 C# | 📅 2026-07-17 - Multi-functional shader for the Particle System that supports Universal Render Pipeline (URP) of Unity.
...
* [crest-oceanrender](https://github.com/huwb/crest-oceanrender) ⭐ 3,876 | 🐛 84 | 🌐 C# | 📅 2026-06-18 - An advanced ocean system implemented in Unity3D
* [Ceto](https://github.com/Scrawk/Ceto) ⭐ 1,083 | 🐛 6 | 🌐 C# | 📅 2022-01-30 - Ceto: Ocean system for Unity
...
* [JasonMaToonRenderPipeline](https://github.com/Jason-Ma-233/JasonMaToonRenderPipeline) ⭐ 2,157 | 🐛 0 | 🌐 C# | 📅 2023-05-26 - JTRP : Unity HDRP ToonShading Render Pipeline
...
* [UniToon](https://github.com/yoship1639/UniToon) ⭐ 560 | 🐛 2 | 🌐 ShaderLab | 📅 2022-06-27 - Physically-based Toon Shader for game applications. Compliant with Unity standard rendering functions. It is not targeted to be multifunctional in order to keep performance, but to be universally usable.
...
* [QFramework](https://github.com/liangxiegame/QFramework) ⭐ 5,418 | 🐛 9 | 🌐 C# | 📅 2026-07-11 - Your first K.I.S.S Unity 3D Framework
...
* [SanAndreasUnity](https://github.com/GTA-ASM/SanAndreasUnity) ⭐ 2,605 | 🐛 40 | 🌐 C# | 📅 2023-06-16 - Open source reimplementation of GTA San Andreas game engine in Unity
* [ezy-slice](https://github.com/DavidArayan/ezy-slice) ⭐ 2,264 | 🐛 10 | 🌐 C# | 📅 2023-08-10 - An open source mesh slicer framework for Unity3D Game Engine. Written in C#.
...
* [UnityTimeRewinder](https://github.com/SitronX/UnityTimeRewinder) ⭐ 316 | 🐛 2 | 🌐 C# | 📅 2024-08-08 - Unity time rewind solution, that is easily customizable for any project.
...
* [Path-Creator](https://github.com/SebLague/Path-Creator) ⭐ 2,084 | 🐛 89 | 🌐 C# | 📅 2024-05-02 - Path creation asset for Unity game development
* [GOAP](https://github.com/crashkonijn/GOAP) ⭐ 1,752 | 🐛 9 | 🌐 C# | 📅 2026-03-06 - A multi-threaded GOAP system for Unity3D
...
* [LDtkUnity](https://github.com/Cammin/LDtkUnity) ⭐ 426 | 🐛 14 | 🌐 C# | 📅 2026-04-11 - A package for easy Unity-integration with the Level Designer Toolkit, created by deepnight: <https://github.com/deepnight/ldtk> ⭐ 4,160 | 🐛 377 | 🌐 Haxe | 📅 2026-07-12
...
* [MoonSharp](https://github.com/xanathar/moonsharp/) ⭐ 1,613 | 🐛 111 | 🌐 C# | 📅 2026-08-04 - An interpreter for the Lua language, written entirely in C# for the .NET, Mono, Xamarin and Unity3D platforms, including handy remote debugger facilities
...
* [MediaPipeUnityPlugin](https://github.com/homuler/MediaPipeUnityPlugin) ⭐ 2,446 | 🐛 53 | 🌐 C# | 📅 2026-01-10 - Unity plugin to run MediaPipe
...
* [UnityGLTF](https://github.com/KhronosGroup/UnityGLTF) ⭐ 2,223 | 🐛 80 | 🌐 C# | 📅 2026-08-21 - Runtime GLTF Loader for Unity3D
...
* [OpenFracture](https://github.com/dgreenheck/OpenFracture) ⭐ 1,133 | 🐛 10 | 🌐 C# | 📅 2024-07-17 - Open source mesh slicing/fracturing utility for Unity
...
* [MelonLoader](https://github.com/LavaGang/MelonLoader) ⭐ 4,123 | 🐛 43 | 🌐 C# | 📅 2026-08-13 - The World's First Universal Mod Loader for Unity Games that is Compatible with both Il2Cpp and Mono.
...
* [UnityDoorstop](https://github.com/NeighTools/UnityDoorstop) ⭐ 583 | 🐛 23 | 🌐 C | 📅 2026-06-22 - Doorstop -- run C# before Unity does!
...
* [Google Mobile Ads Unity Plugin](https://github.com/googleads/googleads-mobile-unity) ⭐ 1,541 | 🐛 166 | 🌐 C# | 📅 2026-08-21 - Official Unity Plugin for the Google Mobile Ads SDK
...
* [FishNet](https://github.com/FirstGearGames/FishNet) ⭐ 2,024 | 🐛 17 | 🌐 C# | 📅 2026-08-21 - FishNet: Unity Networking Evolved
...
* [PurrNet](https://github.com/PurrNet/PurrNet) ⭐ 640 | 🐛 4 | 🌐 C# | 📅 2026-08-21 - A Purrfect Unity Networking Solution
...
* [NodeBasedDialogueSystem](https://github.com/merpheus-dev/NodeBasedDialogueSystem) ⭐ 898 | 🐛 8 | 🌐 C# | 📅 2023-04-28 - Node Based Dialogue System for Unity
...
* [NuGetForUnity](https://github.com/GlitchEnzo/NuGetForUnity) ⭐ 4,550 | 🐛 87 | 🌐 C# | 📅 2026-04-19 - A NuGet Package Manager for Unity
* [OpenUPM](https://github.com/openupm/openupm) ⭐ 1,896 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-22 - OpenUPM - Open Source Unity Package Registry (UPM)
...
* [box3d-unity](https://github.com/Suvitruf/box3d-unity) ⭐ 219 | 🐛 1 | 🌐 C# | 📅 2026-07-31 - Box3d Physics bindings for Unity
...
* [protobuf-net](https://github.com/mgravell/protobuf-net) ⭐ 4,969 | 🐛 538 | 🌐 C# | 📅 2026-08-21 - Protocol Buffers library for idiomatic .NET
...
* [hybridclr](https://github.com/focus-creative-games/hybridclr) ⭐ 7,951 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 - HybridCLR is a fully featured, zero-cost, high-performance, low-memory solution for Unity's all-platform native c# hotupdate.
* [puerts](https://github.com/Tencent/puerts) ⭐ 6,187 | 🐛 312 | 🌐 C++ | 📅 2026-07-31 - PUER(普洱) Typescript. Let's write your game in UE or Unity with TypeScript.
...
* [UnityScreenNavigator](https://github.com/Haruma-K/UnityScreenNavigator) ⭐ 1,113 | 🐛 0 | 🌐 C# | 📅 2026-08-18 - Library for screen transitions, transition animations, transition history stacking, and screen lifecycle management in Unity's uGUI.
...
* [eos\_plugin\_for\_unity](https://github.com/PlayEveryWare/eos_plugin_for_unity) ⭐ 415 | 🐛 12 | 🌐 C# | 📅 2026-08-21 - The eos\_plugin\_for\_unity repository contains the source code for development and support of the Epic Online Services Plugin for Unity (UPM Package) package.
...
* [DOTween](https://github.com/Demigiant/dotween) ⭐ 2,679 | 🐛 308 | 🌐 C# | 📅 2026-07-26 - A Unity C# animation engine. HOTween v2
* [LitMotion](https://github.com/AnnulusGames/LitMotion) ⭐ 2,284 | 🐛 48 | 🌐 C# | 📅 2026-06-30 - Lightning-fast and Zero Allocation Tween Library for Unity.
...
* [UIEffect](https://github.com/mob-sakai/UIEffect) ⭐ 7,593 | 🐛 9 | 🌐 C# | 📅 2026-08-17 - UIEffect is an effect component for uGUI element in Unity. Let's decorate your UI with effects!
* [ParticleEffectForUGUI](https://github.com/mob-sakai/ParticleEffectForUGUI) ⭐ 5,956 | 🐛 43 | 🌐 C# | 📅 2026-07-04 - This plugin provide a component to render particle effect for uGUI in Unity 2018.2+. The particle rendering is maskable and sortable, without Camera, RenderTexture or Canvas
* [unity-ugui-XCharts](https://github.com/monitor1394/unity-ugui-XCharts) ⭐ 3,785 | 🐛 8 | 🌐 C# | 📅 2026-07-17 - A charting and data visualization library for Unity.
...
* [LoopScrollRect](https://github.com/qiankanglai/LoopScrollRect) ⭐ 2,766 | 🐛 1 | 🌐 C# | 📅 2026-06-07 - UGUI ScrollRect reusing cells, to improve performance, loading time and draw calls.
...
* [ReactUnity](https://github.com/ReactUnity/core) ⭐ 892 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-18 - React and HTML framework for Unity UI & UIToolkit
...
* [Auto9Slicer](https://github.com/kyubuns/Auto9Slicer) ⭐ 279 | 🐛 0 | 🌐 C# | 📅 2024-08-06 - Auto 9 slice sprite generator on Unity.
...
* [R3](https://github.com/Cysharp/R3) ⭐ 3,963 | 🐛 29 | 🌐 C# | 📅 2026-07-08 - The new future of dotnet/reactive and UniRx.
* [Rant](https://github.com/TheBerkin/rant) ⚠️ Archived - Robust text engine for procedural generation and postprocessing
* [graphy](https://github.com/Tayx94/graphy) ⭐ 2,898 | 🐛 12 | 🌐 C# | 📅 2024-06-04 - Graphy is the ultimate, easy to use, feature packed stats monitor and debugger for your Unity project
* [Mathfs](https://github.com/FreyaHolmer/Mathfs) ⭐ 2,748 | 🐛 3 | 🌐 C# | 📅 2026-07-31 - Expanded Math Functionality for Unity
...
* [UnityNativeGallery](https://github.com/yasirkula/UnityNativeGallery) ⭐ 1,617 | 🐛 50 | 🌐 Objective-C++ | 📅 2026-07-09 - A native Unity plugin to interact with Gallery/Photos on Android & iOS (save and/or load images/videos)
