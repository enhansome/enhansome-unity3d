...
* [Spine Runtimes](https://github.com/EsotericSoftware/spine-runtimes) ⭐ 5,298 | 🐛 82 | 🌐 C++ | 📅 2026-09-17 - Collection of Spine runtimes including with Unity3d version.
...
* [Unity-MCP](https://github.com/IvanMurzak/Unity-MCP) ⭐ 4,309 | 🐛 52 | 🌐 C# | 📅 2026-09-17 - Open-source MCP server connecting AI agents (Claude, Cursor, GitHub Copilot, Gemini, and more) to the Unity Editor and runtime, with 100+ built-in tools.
...
* [obfuz](https://github.com/focus-creative-games/obfuz) ⭐ 812 | 🐛 0 | 🌐 C# | 📅 2026-09-11 - A powerful open-source code obfuscation plugin for Unity
...
* [YooAsset](https://github.com/tuyoogame/YooAsset) ⭐ 3,368 | 🐛 201 | 🌐 C# | 📅 2026-09-20 - unity3d resources management system
...
* [unity-builder](https://github.com/game-ci/unity-builder) ⭐ 1,093 | 🐛 64 | 🌐 TypeScript | 📅 2026-09-16 - Github action for testing and building Unity projects (formerly webbertakken/unity-actions)
...
* [DeadSimple Pixel-Perfect Camera](https://github.com/cmilr/DeadSimple-Pixel-Perfect-Camera) ⭐ 240 | 🐛 0 | 🌐 C# | 📅 2021-01-23 - An exceedingly easy-to-use pixel perfect orthographic camera script for 2D scenes in Unity. Punch in a few specs and you've got a working pixel perfect camera. It's that easy.
* [Camera-Shake](https://github.com/gasgiant/Camera-Shake) ⭐ 238 | 🐛 4 | 🌐 C# | 📅 2024-08-02 - Camera shake for Unity
...
* [Latios-Framework](https://github.com/Dreaming381/Latios-Framework) ⭐ 1,352 | 🐛 4 | 🌐 C# | 📅 2026-09-07 - A Unity DOTS framework
...
* [reflex](https://github.com/gustavopsantos/reflex) ⭐ 1,620 | 🐛 10 | 🌐 C# | 📅 2026-06-18 - Minimal dependency injection framework for Unity
...
* [Morpeh](https://github.com/X-Crew/Morpeh) ⭐ 666 | 🐛 10 | 🌐 C# | 📅 2026-09-14 - Fast and Simple ECS Framework for Unity3d
...
* [Unity-Editor-Toolbox](https://github.com/arimger/Unity-Editor-Toolbox) ⭐ 1,977 | 🐛 12 | 🌐 C# | 📅 2026-08-25 - Tools, custom attributes, drawers and extensions for Unity Editor.
...
* [NovaShader](https://github.com/CyberAgentGameEntertainment/NovaShader) ⭐ 1,616 | 🐛 1 | 🌐 C# | 📅 2026-09-07 - Multi-functional shader for the Particle System that supports Universal Render Pipeline (URP) of Unity.
...
* [HoyoToon](https://github.com/Melioli/HoyoToon) ⭐ 724 | 🐛 0 | 🌐 C# | 📅 2026-08-10 - Shader for Unity (Built-in Rendering Pipeline) attempting to replicate the shading of miHoYo developed games. This is for datamined assets, not custom-made ones nor the MMD variants.
...
* [QFramework](https://github.com/liangxiegame/QFramework) ⭐ 5,456 | 🐛 8 | 🌐 C# | 📅 2026-09-20 - Your first K.I.S.S Unity 3D Framework
...
* [UnityTimeRewinder](https://github.com/SitronX/UnityTimeRewinder) ⭐ 317 | 🐛 2 | 🌐 C# | 📅 2024-08-08 - Unity time rewind solution, that is easily customizable for any project.
...
* [NavMeshPlus](https://github.com/h8man/NavMeshPlus) ⭐ 2,351 | 🐛 23 | 🌐 C# | 📅 2026-08-29 - Unity NavMesh 2D Pathfinding
...
* [LDtkUnity](https://github.com/Cammin/LDtkUnity) ⭐ 425 | 🐛 14 | 🌐 C# | 📅 2026-04-11 - A package for easy Unity-integration with the Level Designer Toolkit, created by deepnight: <https://github.com/deepnight/ldtk> ⭐ 4,194 | 🐛 387 | 🌐 Haxe | 📅 2026-07-12
...
* [xLua](https://github.com/Tencent/xLua) ⭐ 10,197 | 🐛 288 | 🌐 C | 📅 2025-11-21 - xLua is a hot-fix solution plugin for Unity3D, it supports android, ios, windows, osx, etc.
...
* [ILSpy](https://github.com/icsharpcode/ILSpy) ⭐ 26,106 | 🐛 176 | 🌐 C# | 📅 2026-09-21 - .NET Decompiler with support for PDB generation, ReadyToRun, Metadata (\&more) - cross-platform!
...
* [Harmony](https://github.com/pardeike/Harmony) ⭐ 6,659 | 🐛 17 | 🌐 C# | 📅 2026-09-08 - A library for patching, replacing and decorating .NET and Mono methods during runtime.
* [Fody](https://github.com/Fody/Fody) ⭐ 4,544 | 🐛 8 | 🌐 C# | 📅 2026-09-16 - Extensible tool for weaving .net assemblies.
* [MelonLoader](https://github.com/LavaGang/MelonLoader) ⭐ 4,204 | 🐛 46 | 🌐 C# | 📅 2026-09-05 - The World's First Universal Mod Loader for Unity Games that is Compatible with both Il2Cpp and Mono.
...
* [UnityDoorstop](https://github.com/NeighTools/UnityDoorstop) ⭐ 594 | 🐛 22 | 🌐 C | 📅 2026-09-20 - Doorstop -- run C# before Unity does!
...
* [FishNet](https://github.com/FirstGearGames/FishNet) ⭐ 2,053 | 🐛 15 | 🌐 C# | 📅 2026-09-02 - FishNet: Unity Networking Evolved
...
* [PurrNet](https://github.com/PurrNet/PurrNet) ⭐ 677 | 🐛 4 | 🌐 C# | 📅 2026-09-20 - A Purrfect Unity Networking Solution
...
* [promul](https://github.com/jacksonrakena/promul) ⭐ 62 | 🐛 1 | 🌐 C# | 📅 2023-12-12 - An open-source networking & relay implementation for Unity Netcode for GameObjects
...
* [InstantPipes](https://github.com/leth4/InstantPipes) ⭐ 393 | 🐛 0 | 🌐 C# | 📅 2023-09-26 - Unity editor tool for quickly generating pipes—with pathfinding
...
* [protobuf-net](https://github.com/mgravell/protobuf-net) ⭐ 4,975 | 🐛 536 | 🌐 C# | 📅 2026-09-18 - Protocol Buffers library for idiomatic .NET
...
* [UnityRuntimeInspector](https://github.com/yasirkula/UnityRuntimeInspector) ⭐ 2,166 | 🐛 10 | 🌐 C# | 📅 2026-08-30 - Runtime Inspector and Hierarchy solution for Unity for debugging and runtime editing purposes
* [RuntimeUnityEditor](https://github.com/ManlyMarco/RuntimeUnityEditor) ⭐ 1,117 | 🐛 9 | 🌐 C# | 📅 2026-09-04 - In-game inspector and debugging tools for applications made with Unity3D game engine
...
* [hybridclr](https://github.com/focus-creative-games/hybridclr) ⭐ 7,974 | 🐛 0 | 🌐 C++ | 📅 2026-08-20 - HybridCLR is a fully featured, zero-cost, high-performance, low-memory solution for Unity's all-platform native c# hotupdate.
* [puerts](https://github.com/Tencent/puerts) ⭐ 6,208 | 🐛 311 | 🌐 C++ | 📅 2026-09-20 - PUER(普洱) Typescript. Let's write your game in UE or Unity with TypeScript.
...
* [eos\_plugin\_for\_unity](https://github.com/PlayEveryWare/eos_plugin_for_unity) ⭐ 423 | 🐛 11 | 🌐 C# | 📅 2026-09-18 - The eos\_plugin\_for\_unity repository contains the source code for development and support of the Epic Online Services Plugin for Unity (UPM Package) package.
...
* [UIEffect](https://github.com/mob-sakai/UIEffect) ⭐ 7,661 | 🐛 9 | 🌐 C# | 📅 2026-08-27 - UIEffect is an effect component for uGUI element in Unity. Let's decorate your UI with effects!
* [ParticleEffectForUGUI](https://github.com/mob-sakai/ParticleEffectForUGUI) ⭐ 6,000 | 🐛 43 | 🌐 C# | 📅 2026-09-07 - This plugin provide a component to render particle effect for uGUI in Unity 2018.2+. The particle rendering is maskable and sortable, without Camera, RenderTexture or Canvas
...
* [FancyScrollView](https://github.com/setchi/FancyScrollView) ⭐ 3,527 | 🐛 11 | 🌐 C# | 📅 2022-07-08 - A scrollview component that can be implemented flexible flexible animation
...
* [ZLinq](https://github.com/Cysharp/ZLinq) ⭐ 5,274 | 🐛 6 | 🌐 C# | 📅 2026-07-08 - Zero allocation LINQ with LINQ to Span, LINQ to SIMD, and LINQ to Tree (FileSystem, JSON, GameObject, etc.) for all .NET platforms and Unity, Godot.
...
* [R3](https://github.com/Cysharp/R3) ⭐ 3,997 | 🐛 27 | 🌐 C# | 📅 2026-08-26 - The new future of dotnet/reactive and UniRx.
* [Rant](https://github.com/TheBerkin/rant) ⚠️ Archived - Robust text engine for procedural generation and postprocessing
* [graphy](https://github.com/Tayx94/graphy) ⭐ 2,906 | 🐛 12 | 🌐 C# | 📅 2026-08-29 - Graphy is the ultimate, easy to use, feature packed stats monitor and debugger for your Unity project
...
* [Evolunity](https://github.com/Bodix/Evolunity) ⭐ 64 | 🐛 1 | 🌐 C# | 📅 2026-09-20 - Well-designed package with useful scripting tools for Unity development
...
* [unity-webview](https://github.com/gree/unity-webview) ⭐ 2,666 | 🐛 443 | 🌐 Objective-C++ | 📅 2026-09-20 - A plugin for Unity 5 that overlays WebView components on Unity view. It works on Android, iOS, Unity Web Player, and OS X (Windows is not supported for now).
